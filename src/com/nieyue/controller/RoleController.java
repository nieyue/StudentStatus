...
public class RoleController {
	...
	public @ResponseBody StateResultList<List<Role>> updateRole(@ModelAttribute Role role,HttpSession session)  {
	...
	public @ResponseBody StateResultList<List<Role>> addRole(@ModelAttribute Role role, HttpSession session) {
	...
	public @ResponseBody StateResultList<List<Role>> delRole(@RequestParam("roleId") Integer roleId,HttpSession session)  {
	...
	public @ResponseBody StateResultList<List<Integer>> countAll(HttpSession session)  {
		Integer count = roleService.countAll();
